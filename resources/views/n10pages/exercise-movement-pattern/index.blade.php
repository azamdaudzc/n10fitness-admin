                                    ...
                                    <div class="modal-dialog modal-dialog-centered mw-650px">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-header" id="kt_modal_add_user_header">
                                                <!--begin::Modal title-->
                                                <h2 class="fw-bold">Add Movement Pattern</h2>
                                                <!--end::Modal title-->
                                                <!--begin::Close-->
                                                <div class="btn btn-icon btn-sm btn-active-icon-primary"
                                                    data-kt-users-modal-action="close">
                        ...
                        <div class="card-body py-4">
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                ...
                                <tbody class="text-gray-600 fw-semibold">
                                    <!--begin::Table row-->
                                    @foreach($exerciseMovementPatterns as $at)
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="{{ route('exercise-movement-patterns.edit',$at->id) }}"
                                                ...
                                                <form class="menu-item px-3" action="{{ route('exercise-movement-patterns.destroy',$at->id) }}" method="POST">
                                                    @csrf
                                                   @method('DELETE')
...
@section('scripts')
     ...
     <script type="text/javascript">
        $(function () {
          ...
          var table = $('.exercise_movement_patterns_tables').DataTable({
              processing: true,
              serverSide: true,
              ajax: "get-exercise-movement-patterns",
              columns: [
                  {data: 'id', name: 'id'},
                  {data: 'name', name: 'name'},
