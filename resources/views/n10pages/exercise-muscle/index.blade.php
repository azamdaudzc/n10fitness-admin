                                    ...
                                    <div class="modal-dialog modal-dialog-centered mw-650px">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-header" id="kt_modal_add_user_header">
                                                <!--begin::Modal title-->
                                                <h2 class="fw-bold">Add Muscle</h2>
                                                <!--end::Modal title-->
                                                <!--begin::Close-->
                                                <div class="btn btn-icon btn-sm btn-active-icon-primary"
                                                    data-kt-users-modal-action="close">
                                            ...
                                            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                                ...
                                                <form method="POST" action="{{ route('exercise-libraries.store') }}"  role="form" id="createNewForm" enctype="multipart/form-data">
                                                    ...
                                                    @include('n10pages.exercise-muscle.form')
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="{{ route('exercise-muscles.edit',$at->id) }}"
                                                ...
                                                <form class="menu-item px-3" action="{{ route('exercise-muscles.destroy',$at->id) }}" method="POST">
                                                    @csrf
                                                   @method('DELETE')
...
@section('scripts')
     ...
     <script type="text/javascript">
        $(function () {
          ...
          var table = $('.exercise_muscles_tables').DataTable({
              processing: true,
              serverSide: true,
              ajax: "get-exercise-muscles",
              columns: [
                  {data: 'id', name: 'id'},
                  {data: 'name', name: 'name'},
