                                    ...
                                    <div class="modal-dialog modal-dialog-centered mw-650px">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-header" id="kt_modal_add_user_header">
                                                <!--begin::Modal title-->
                                                <h2 class="fw-bold">Add Exercise Library Muscles</h2>
                                                <!--end::Modal title-->
                                                <!--begin::Close-->
                                                <div class="btn btn-icon btn-sm btn-active-icon-primary"
                                                    data-kt-users-modal-action="close">
                                            ...
                                            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                               ...
                                               <!--begin::Form-->
                                                <form method="POST" action="{{ route('exercise-libraries.store') }}"  role="form" id="createNewForm" enctype="multipart/form-data">
                                                    ...
                                                    @include('n10pages.exercise-library-mucle.form')
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                ...
                                <thead>
                                    ...
                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-125px">Library Id</th>
                                        <th class="min-w-125px">Muscle Id</th>
                                ...
                                <tbody class="text-gray-600 fw-semibold">
                                    <!--begin::Table row-->
                                    @foreach($excerciseLibraryMuscles as $at)
                                    <tr>
                                        ...
                                        <!--begin::Joined-->
                                        <td> {{$at->name}}</td>
                                        <td>{{$at->exercise_library_id}}</td>
                                        <td>{{$at->excercise_muscle_id}}</td>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="{{ route('excercise-library-muscles.edit',$at->id) }}"
                                                ...
                                                <form class="menu-item px-3" action="{{ route('excercise-library-muscles.destroy',$at->id) }}" method="POST">
                                                    @csrf
                                                   @method('DELETE')
...
@section('scripts')
     ...
     <script type="text/javascript">
        $(function () {
          ...
          var table = $('.excercise_library_muscles_tables').DataTable({
              processing: true,
              serverSide: true,
              ajax: "get-excercise-library-muscles",
              columns: [
                  {data: 'id', name: 'id'},
                  {data: 'name', name: 'name'},
