                        ...
                        <div class="card-body py-4">
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                ...
                                <tbody class="text-gray-600 fw-semibold">
                                    <!--begin::Table row-->
                                    @foreach($exerciseCategories as $at)
                                    <tr>
                                        ...
                                        <!--begin::Joined-->
                                        <td onclick="showInfoModal('{{$at->id}}')" class="text-gray-800 text-hover-primary mb-1" > {{$at->name}}</td>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="{{ route('exercise-categories.edit',$at->id) }}"
                                                ...
                                                <form class="menu-item px-3" action="{{ route('exercise-categories.destroy',$at->id) }}" method="POST">
                                                    @csrf
                                                   @method('DELETE')
...
@section('scripts')
     ...
     <script type="text/javascript">
        $(function () {
          ...
          var table = $('.exercise_categories_tables').DataTable({
              processing: true,
              serverSide: true,
              ajax: "get-exercise-categories",
              columns: [
                  {data: 'id', name: 'id'},
                  {data: 'name', name: 'name'},
