                        ...
                        <div class="card-header border-0 pt-6">
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                    ...
                                    <a href="{{ route('athletic-types.create') }}"><button type="button"  class="btn btn-primary btn-sm float-right"  data-placement="left">
                                        {{ __('Create New') }}
                                        <span class="svg-icon svg-icon-2">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered mw-650px">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-header" id="kt_modal_add_user_header">
                                                <!--begin::Modal title-->
                                                <h2 class="fw-bold">Add AthleticTypes</h2>
                                                <!--end::Modal title-->
                                                <!--begin::Close-->
                                                <div class="btn btn-icon btn-sm btn-active-icon-primary"
                                                    data-kt-users-modal-action="close">
                                                                ...
                                                                <div class="form-check form-check-custom form-check-solid">
                                                                    ...
                                                                    <label class="form-check-label"
                                                                        ...
                                                                        <div class="text-gray-600">Best for people who
                                                                            need full access to analytics data, but don't
                                                                            need to update business settings</div>
                                                                    </label>
                                                                    <!--end::Label-->
                                                                </div>
                                                                <!--end::Radio-->
                                                            ...
                                                            <div class="d-flex fv-row">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <label class="form-check-label"
                                                                        ...
                                                                        <div class="text-gray-600">Best for people who
                                                                            need to preview content data, but don't need to
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="{{ route('athletic-types.edit',$at->id) }}"
                                                ...
                                                <form class="menu-item px-3" action="{{ route('athletic-types.destroy',$at->id) }}" method="POST">
                                                    @csrf
                                                   @method('DELETE')
...
@section('scripts')
        ...
        $(function() {
            $.ajax({
                'url': "get-athletic-types",
                'method': "GET",
                'contentType': 'application/json'
            }).done( function(data) {
            var datatable = $('#athletic_types_table').DataTable({
                info: !1,
                data:data,
                columns: [
                { title: "ID" },
    ...
    {{-- <script type="text/javascript">
        $(function () {
          ...
          var table = $('.athletic_types_tables').DataTable({
              processing: true,
              serverSide: true,
              ajax: "get-athletic-types",
              columns: [
                  {data: 'id', name: 'id'},
                  {data: 'name', name: 'name'},
