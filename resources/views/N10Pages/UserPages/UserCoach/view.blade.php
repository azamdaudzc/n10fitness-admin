                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                            <!--begin::Form-->
                            <form id="kt_modal_add_client_form" method="POST" class="form" action="{{route('user.coach.attachclient')}}">
                                @csrf
                                <input type="hidden" name="coach_id" id="">
                                <!--begin::Input group-->
                                <div class="fv-row mb-7">
                                    <!--begin::Label-->
...
@section('page_scripts')
    <script>
        ...
        let table = $('#users_table').DataTable({
            ...
            lenghtChange:false,
            ajax: {
                url: "{{ route('user.coach.assigedclients') }}",
            },
            columns: [{
                data: 'user'
            },
