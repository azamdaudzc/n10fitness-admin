<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
    ...
    <div class="card-body p-9">
        ...
        <div class="row mb-7">
            <!--begin::Label-->
            <label class="col-lg-12 fw-semibold text-muted">Days</label>
            <!--end::Label-->
            <!--begin::Col-->
            <div class="col-lg-12 fv-row">
                <span class="fw-semibold text-gray-800 fs-6">{{ $data->days }}</span>
            </div>
            <!--end::Col-->
        </div>
        <!--end::Input group-->
        ...
        <div class="row mb-7">
            <!--begin::Label-->
            <label class="col-lg-12 fw-semibold text-muted">Weeks</label>
            <!--end::Label-->
            <!--begin::Col-->
            <div class="col-lg-12 fv-row">
                <span class="fw-semibold text-gray-800 fs-6">{{ $data->weeks }}</span>
            </div>
            <!--end::Col-->
        </div>
        <!--end::Input group-->
            ...
            @foreach ($videos as $lm)
                <div class="warmupvideo-container">
                    ...
                    <a href="{{ $lm->video_url }}" target="_blank">
                        <div class="warmupvideo-button"><img
                                src="{{ asset('assets/media/sample/video-play-icon.png') }}" class="warmupvideo-text"
                                alt="">
                        </div>
                    </a>
                </div>
