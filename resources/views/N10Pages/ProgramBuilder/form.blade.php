                ...
                <div class="card-body py-5">
                    ...
                    <form method="POST" id="crud-form" action="{{ route('program.builder.store') }}" role="form"
                        ...
                        <div class="mb-10">
                            ...
                            <textarea class="form-control" placeholder="description" name="description" type="text" id="description">{{ @$data->description }}</textarea>
                        </div>

                        <div class="mb-10">
                            <label for="instruction" class="form-label">Instruction</label>
                            <textarea class="form-control" placeholder="instruction" name="instructions" type="text" id="instruction">{{ @$data->instructions }}</textarea>
                        </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="file" name="thumbnail"
                                                        class="form-control mb-2 mb-md-0 imgInp" placeholder="Thumbnail"
                                                        value="{{ $wv->thumbnail }}" />
                                                    <input type="hidden" value="{{ $wv->thumbnail }}" name="old_thumbnail">
                                                </div>
                                                <div class="col-md-3">
                                                    <img @if ($wv->thumbnail == null) src="{{ asset('assets/media/sample/image-area.jpg') }}" @else src="{{ $wv->thumbnail }}" @endif
                                                        class=" mt-3 thumbnail-image " />
                                    ...
                                    @if (!$warmupvideos->count() > 0)
                                        <div data-repeater-item>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-3">
                                                    <img src="{{ asset('assets/media/sample/image-area.jpg') }}"
                                                        class=" mt-3 thumbnail-image " />
                    ...
                    success: function(d, status) {
                        if (d.success == true) {
                            ...
                            window.location.href =
                                "{{ route('program.builder.index') }}?goto=" + goto;
            ...
            $('body').on('change', '.imgInp', function() {
                ...
                if (input.files && input.files[0]) {
                    ...
                    reader.onload = function(e) {
                        $(input).parent().parent().find('.thumbnail-image').attr("src", e.target
                        .result);
                    }
